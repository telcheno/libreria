package it.tcheca.libreria.controller;
...
import it.tcheca.libreria.repository.BookRepository;
...
public class BookController {
	...
	public String edit(@PathVariable("id") Integer idEdit, Model model) {
		...
		model.addAttribute("book", repositoryBook.getReferenceById(idEdit));
//		opzione di uso con lo steso risultato
